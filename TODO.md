...
- [x] Clarify the Major 2nd spelling rule: use the lower/current note as reference, so bar 152 remains `C♯5 – B4` (B4 with C♯5 a major second above), despite the descending playing order.
...
- [x] Update Major 2nd descending study to step down in 1/2 tone (semitone) increments from D5 to C4 (`D5 – C5...`, `C♯5 – B4...`, down to `D4 – C4...`, 13 measures total).
